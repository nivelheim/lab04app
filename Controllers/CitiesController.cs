...
namespace Week04Lab.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CityId,CityName,Population,ProvinceId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CityId,CityName,Population,ProvinceId")] City city)
        {
            if (ModelState.IsValid)
            {
